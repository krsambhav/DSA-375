  ...
  return (
    <div className="transition-all duration-300 bg-white dark:bg-slate-900 pb-10">
      ...
      <main className="w-screen flex flex-col items-center p-10 md:px-24 min-h-screen select-none">
        ...
        {totalSolved && totalProblems ? <div className="progress-container mt-10 w-[100px]">
          <CircularProgressbar
            value={totalSolved/totalProblems*100}
            text={`${Math.round(totalSolved/totalProblems*100)}% Solved`}
            styles={buildStyles({
              strokeLinecap: "butt",
              textSize: "14",
              textColor: "#AAA",
          ...
          />
        </div> : <div className="progress-container mt-10 w-[100px]">
          <CircularProgressbar
            value={0}
            text={`Start Solving`}
            styles={buildStyles({
