...
export default function Card({ topic, title, qty, index }: { topic:string, title: string; qty?: any; index:number }) {
  ...
  return (
    <Link href={'/quest/'+topic.toLowerCase()}>
      <a>
      <div className="border-[0.1px] border-black w-[240px] h-[150px] flex flex-col justify-center items-center text-2xl cursor-pointer card transition-all duration-200 dark:border-white dark:hover:border-orange-200 normalcard">
